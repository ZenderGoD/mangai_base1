    ...
    <div className={`relative w-full max-w-[500px] ${className}`}>
      <div
        ...
        className={`max-h-[400px] overflow-y-auto p-4 ${
          displayScrollbar
            ? '[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-muted [&::-webkit-scrollbar-thumb]:bg-muted-foreground/20 [&::-webkit-scrollbar-thumb]:rounded-[4px] [&::-webkit-scrollbar-thumb]:hover:bg-muted-foreground/30'
            : 'scrollbar-hide'
        }`}
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div className={`p-4 bg-card border border-border rounded-lg transition-colors ${selectedIndex === index ? 'bg-accent' : ''} ${itemClassName}`}>
